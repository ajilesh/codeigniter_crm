<!-- footer -->
    ...
    <script src="<?php echo base_url();?>libs/flot/jquery.flot.time.js"></script>
    <script src="<?php echo base_url();?>libs/flot/jquery.flot.stack.js"></script>
    <script src="<?php echo base_url();?>libs/flot/jquery.flot.crosshair.js"></script>
    <script src="<?php echo base_url();?>libs/flot.tooltip/js/jquery.flot.tooltip.min.js"></script>
